...
interface YouTubeDialogProps {
  ...
  onSubmit: (data: { src: string; width: number; height: number; start: number }) => void
}
          ...
          <div className="grid gap-4 py-4">
            ...
            {src && !isValid && (
              <div className="col-span-4 text-sm text-red-500 ml-[calc(25%+0.5rem)]">
                Invalid YouTube URL. Please enter a valid YouTube URL or YouTube Shorts URL.
              </div>
            )}
            {isValid && videoId && (
              ...
              <div className="col-span-3 flex gap-2">
                ...
                <div className="w-1/2">
                  ...
                  <Input
                    ...
                    max="720"
                    value={height}
                    onChange={(e) => setHeight(Number.parseInt(e.target.value) || 360)}
                  />
                </div>
              </div>
            </div>
