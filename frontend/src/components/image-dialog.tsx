...
export function ImageDialog({ open, onOpenChange, onSubmit, initialValues = {} }: ImageDialogProps) {
  ...
  const [alignment, setAlignment] = useState(initialValues.alignment || "center")
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <RadioGroup value={alignment} onValueChange={setAlignment} className="col-span-3 flex gap-4">
