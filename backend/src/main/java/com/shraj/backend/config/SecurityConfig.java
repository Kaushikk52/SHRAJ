package com.shraj.backend.config;

import com.shraj.backend.security.JwtAuthenticationEntryPoint;
import com.shraj.backend.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,"/v1/api/blogs/**").authenticated()
                )
